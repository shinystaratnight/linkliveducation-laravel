                ...
                <div class="content content-boxed">
                    <div class="row">
                               ...
                               <div class="block-content block-content-narrow"> 
                                <table class="table table-hover">
                                    <thead>
                                            ...
                                            <tr>
                                                {!! Form::open(array('url' => 'admin/delete_sub_sub_cat','id' => 'delete_sub_sub_cat','role'=>'form','enctype' => 'multipart/form-data')) !!}
						...
						@endif
                                                ...
                                                <td>
                                                    <select name="videosubcategory" id="subcategory" onchange="loadSubCategory(this.value)">
                                                ...
                                                <td>
                                                    <select name="videosub_subcategory" id="sub_subcategory" onchange="updatesubCate(this.value)">
...
<div class="modal fade" id="edit_cat_modal" role="dialog">
	...
	<div class="modal-content">
            ...
            {!! Form::open(array('url' => 'admin/edit_sub_sub_cat','id' => 'edit_sub_sub_cat','role'=>'form','enctype' => 'multipart/form-data')) !!}
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
		...
		<div class="modal-body">
            ...
            <!-- content goes here -->
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control in-put-bl" id="updatesubCate" name="sub_sub_category_name" placeholder="Title" value="" required>
              </div>
           
                <input type="hidden" class="form-control in-put-bl" id="updatesubCateid" name="sub_sub_category_id" placeholder="Title" value="" required>
...
function loadSubCategory(key){
    $.get('../pages/videow/sub',{sub_cat_id: key}, function (data){
    if(data){
     $('#sub_subcategory').html('');
      $('#sub_subcategory').append(data);
    }
    });
}


function updatesubCate(key){
    

var tr=$("#sub_subcategory option:selected").text();
    $('#updatesubCate').val('');
    $('#updatesubCate').val(tr);
    
    $('#updatesubCateid').val('');
    $('#updatesubCateid').val(key);
