...
@section("content")
				 ...
				 <!-- Page Content -->
                <div class="content">
                    <h1 class="user-head">Pending Influencers</h1>
                        <ul class="dash-btn">
                            <li class="active"><a  href="{{ URL::to('admin/influencers') }}" >All Influencers</a></li>
                        </ul>    
                {!! Form::open(array('url' => array('admin/select_influencer_cat'),'method'=>'get','role'=>'form','enctype' => 'multipart/form-data')) !!}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="font-w600">
                                            ...
                                            @else
                                            <a href="{{URL::to('admin/influencer_approve/'.$users->id)}}" data-toggle="tooltip" title="approved" class="text-danger">Pending</a>
                                            @endif
                                        </td>
