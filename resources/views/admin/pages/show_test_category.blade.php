    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="{{ URL::to('admin/pages/add_test_category') }}">Add Test Categories</a></li>
                ...
                <div class="block-content block-content-narrow"> 
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="{{Url::to('admin/delete_test_category/'.$row->id)}}" onclick="return confirm('Are you sure? You will not be able to recover this.')">Delete</a></td>
                        </tr>
                        @endforeach
                    </table>
                </div>
...
<div class="modal fade" id="edit_cat_modal{{$row->id}}" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(array('url' => 'admin/edit_test_category','role'=>'form','enctype' => 'multipart/form-data')) !!}
