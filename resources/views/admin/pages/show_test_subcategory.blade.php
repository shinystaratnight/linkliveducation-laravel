    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="{{ URL::to('admin/pages/add_test_subcategory') }}">Add Course SubCategories</a></li>
            ...
            <div class="block">
                <div class="block-content block-content-narrow"> 
                    <table class="table table-hover">
                        ...
                        <tr>
                            {!! Form::open(array('url' => 'admin/delete_test_subcategory','role'=>'form','enctype' => 'multipart/form-data')) !!}
...
<div class="modal fade" id="edit_cat_modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(array('url' => 'admin/edit_test_subcategory','role'=>'form','enctype' => 'multipart/form-data')) !!}
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
