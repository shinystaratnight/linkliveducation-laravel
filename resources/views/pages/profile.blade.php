        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="back-image-of-edit-to-profile">
                    <img  src="{{ URL::asset('/'.Auth::user()->cover_pic)}}" class="img-responsive" id="output" style="transform: rotate({{@$post->imgrotation}}deg);">
                </div>
            </div>
            <div class="modal-footer">
                {!! Form::open(array('url' => 'cover_pic','id'=>'cover_pic','role'=>'form','enctype' => 'multipart/form-data')) !!}
