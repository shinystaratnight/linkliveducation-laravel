        ...
        <div class="main-form">
            <div class="row">
                <div class="col-sm-7 hidden-xs">
                    ...
                    <figure>
                        <img src="{{ URL::asset('profile_assets/site_assets/images/login-page.png')}}" class="img-responsive" alt="form-img" />
                    </figure>
                </div>
                    ...
                    <div class="create-form">
                        ...
                        <div class="row">
                            <div class="message col-sm-12">
                                ...
                                @endif
                                @if(Session::has('dob_flash'))
                                <div class="alert alert-danger">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">&times;</span></button>
                                    {{ Session::get('dob_flash') }}
                                </div>
                                @endif
                            ...
                            {!! Form::open(array('url' => 'register','id'=>'sign_up','role'=>'form','enctype' => 'multipart/form-data')) !!}
