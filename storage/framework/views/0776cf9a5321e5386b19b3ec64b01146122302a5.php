...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="./site_assets/images/1Learning.jpg" alt="Los Angeles">
    </div>

    <div class="item">
      <img src="./site_assets/images/2Certified.jpg" alt="Chicago">
    </div>

    <div class="item">
      <img src="./site_assets/images/3JobOpportunity.jpg" alt="New York">
    </div>
  </div>
