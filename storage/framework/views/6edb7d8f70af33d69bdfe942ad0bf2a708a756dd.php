            ...
            <div class=" profile-section-new">
                <div class="clearfix">
                    <ul class="profile-menu">
                        ...
                        <?php if(count(Auth::user()->tests)>0): ?>
                        <li>
                            <a href="<?php echo e(URL::to('/results')); ?>">Results</a>
                        </li>
                            <li>
                                <a href="<?php echo e(URL::to('/user_tests')); ?>">Tests</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
...
</script><?php /**PATH /home/scholer1/public_html/resources/views/includes/user_profile_nav.blade.php ENDPATH**/ ?>