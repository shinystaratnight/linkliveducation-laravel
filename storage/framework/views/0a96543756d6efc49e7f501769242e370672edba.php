            ...
            <?php $__currentLoopData = $coursesubcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coursesub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <div class="col-lg-4 col-md-6 col-xs-12">
                <div class="services-item text-center">
                  ...
                  <h4><a href="<?php echo e(URL::to('view-course/'.$coursesub->id.'/'.$coursesub->name)); ?>" ><?php echo e($coursesub->name); ?></a></h4>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/scholer1/public_html/resources/views/pages/video_courses.blade.php ENDPATH**/ ?>