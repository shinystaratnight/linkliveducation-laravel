    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="<?php echo e(URL::to('admin/pages/add_course_category')); ?>">Add Course Categories</a></li>
                ...
                <div class="block-content block-content-narrow"> 
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo e(Url::to('admin/delete_course_category/'.$row->id)); ?>" onclick="return confirm('Are you sure? You will not be able to recover this.')">Delete</a></td>
                        </tr>
...
<div class="modal fade" id="edit_cat_modal<?php echo e($row->id); ?>" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo Form::open(array('url' => 'admin/edit_course_category','role'=>'form','enctype' => 'multipart/form-data')); ?>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\linkliveducation\resources\views/admin/pages/show_study_mat_category.blade.php ENDPATH**/ ?>