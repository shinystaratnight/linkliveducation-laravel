    ...
    <div class="row items-push">
        ...
        <div class="col-sm-5 text-right hidden-xs">
            <ol class="breadcrumb push-10-t">
                <li><a href="<?php echo e(URL::to('admin/pages/add_course_subcategory')); ?>">Add Course SubCategories</a></li>
            ...
            <div class="block">
                <div class="block-content block-content-narrow"> 
                    <table class="table table-hover">
                        ...
                        <tr>
                            <?php echo Form::open(array('url' => 'admin/delete_course_subcategory','role'=>'form','enctype' => 'multipart/form-data')); ?>
...
<div class="modal fade" id="edit_cat_modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <?php echo Form::open(array('url' => 'admin/edit_course_subcategory','role'=>'form','enctype' => 'multipart/form-data')); ?>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\linkliveducation\resources\views/admin/pages/show_study_mat_subcategory.blade.php ENDPATH**/ ?>