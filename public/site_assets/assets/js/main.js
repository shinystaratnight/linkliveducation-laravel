...
$(document).ready(function () {
  //initialize swiper when document ready
  var mySwiper = new Swiper ('.contents-partner .swiper-container', {
    // Optional parameters
    direction: 'horizontal',
...
$('.tester').click(function(){
  if($('.tester-images').hide()){
    $('.tester-images').css("display","inline-flex");
    $('.learner-images').hide();
  }
});
$('.learner').click(function(){
  if($('.learner-images').hide()){
    $('.learner-images').css("display","inline-flex");
    $('.tester-images').hide();
  }
});