...
window.randomScalingFactor = function(a) {
    return a = a || 100, Math.random(), 1 * Math.round(Math.random() * a)
}, window.randomScalingFactor2 = function() {
    return (Math.random() > 0 ? 1.5 : 1) * Math.round(1e3 * Math.random())
};
var MONTHS = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
    DAYS = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
    progress = document.getElementById("salesVisitProgress"),
    configVisitSales = {
        type: "line",
        data: {
            labels: DAYS,
...
window.onload = function() {
    var a = document.getElementById("salesVisit").getContext("2d");
    window.myLineVisits = new Chart(a, configVisitSales);
    var o = document.getElementById("trafficSource").getContext("2d");
    window.trafficSourceChart = new Chart(o, configTrafficSource);
}
